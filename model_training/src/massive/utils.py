...
class Trainer:
    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            ...
            # Train for an epoch
            for i, (ids, masks, labels, scenarios) in enumerate(self.train_loader):
            ...
            val_loss, accuracy, accuracy_scn = self.calculate_loss_accuracy(loader=self.val_loader)
            print('Epoch: %d Validation loss: %.5f accuracy: %.5f accuracy_scn: %.5f' % (epoch + 1, val_loss, accuracy, accuracy_scn), flush=True)

            test_loss, accuracy, accuracy_scn = self.calculate_loss_accuracy(loader=self.test_loader)
    ...
    def evaluate(self, name, loader):
        loss, accuracy, accuracy_scn = self.calculate_loss_accuracy(loader)
